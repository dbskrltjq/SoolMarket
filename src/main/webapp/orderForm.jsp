				...
				<tr>
					...
					<td>
						...
						<small>
							...
							<span>(보유 포인트 : <strong id="user-point"><%=StringUtil.numberToString(user.getPoint()) %></strong>원)</span>
						</small>
					</td>
				</tr>		
				<tr>
					...
					<td>
						...
						<input type="hidden" name="paymentPrice" value="<%=StringUtil.numberToString(totalPdsPrice + totalDeliveryCharge) %>"/>				
					</td>	
				</tr>		
			</tbody>
		</table>
