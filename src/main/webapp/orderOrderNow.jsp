...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	order.setDepositPoint(Integer.parseInt(request.getParameter("depositPoint").replace(",", "")));							// 적립 포인트	
	...
	int depositPoint = Integer.parseInt(request.getParameter("depositPoint").replace(",", ""));		// 적립포인트
